...
export class KeywordResolverBase {
  ...
  async createKeyword(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        parentKeyword: args.data.parentKeyword
          ? {
              connect: args.data.parentKeyword,
            }
          : undefined,
      },
    });
  ...
  async interested(
    ...
    const results = await this.service.findInterested(parent.id, args);
  ...
  async keywords(
    ...
    const results = await this.service.findKeywords(parent.id, args);
  ...
  async parentKeyword(
    ...
    const result = await this.service.getParentKeyword(parent.id);
