...
@ArgsType()
class UpdateResourceHistoryArgs {
  @Field(() => ResourceHistoryWhereUniqueInput, { nullable: false })
  where!: ResourceHistoryWhereUniqueInput;
  @Field(() => ResourceHistoryUpdateInput, { nullable: false })
  data!: ResourceHistoryUpdateInput;
}

export { UpdateResourceHistoryArgs };
